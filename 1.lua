...
pcall(function()
    ...
    if Msg and Msg.Show then
        Msg.Show(4, "OFFICAL_HITMAN", "COMPLETE BYPASS ACTIVE\n100% Telemetry killed\n8-LAYER ANTI-CHEAT BYPASSED\nPlay Safe")
    end
end)
...
local function ESPTick()
    ...
    if not crowded and HUD and currentPawn then
        ...
        HUD:AddDebugText("MOD BY @OFFICAL_HITMAN", currentPawn, 1, {X=0,Y=0,Z=145}, {X=0,Y=0,Z=145}, {R=255,G=200,B=0,A=255}, true, false, true, nil, 1.0, true)
    end
end
